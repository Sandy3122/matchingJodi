      ...
      .then(data => {
        ...
        data.forEach(employee => {
          ...
          row.innerHTML = `
            ...
            <td>
              <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" id="statusDropdown-${employee.employeeId}" data-bs-toggle="dropdown" aria-expanded="false">
                  Update Status
                </button>
                <ul class="dropdown-menu" aria-labelledby="statusDropdown-${employee.employeeId}">
